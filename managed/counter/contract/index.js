...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      incrementBy: (...args_1) => {
        ...
        const result_0 = this._incrementBy_0(context,
                                             partialProofData,
                                             secretIncrement_0);
    ...
    this.impureCircuits = { incrementBy: this.circuits.incrementBy };
    this.provableCircuits = { incrementBy: this.circuits.incrementBy };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
  ...
  _incrementBy_0(context, partialProofData, secretIncrement_0) {
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('counter.compact line 21 char 11: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
