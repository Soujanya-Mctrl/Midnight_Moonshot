...
export class Contract {
      ...
      submitFeedback: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('submitFeedback',
                                     ...
                                     'feedback.compact line 8 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(rating_0) === 'bigint' && rating_0 >= 0n && rating_0 <= 4294967295n)) {
          __compactRuntime.typeError('submitFeedback',
  ...
  _submitFeedback_0(context, partialProofData, rating_0) {
    __compactRuntime.assert(rating_0 >= 1n, 'Rating must be at least 1 star');
    __compactRuntime.assert(rating_0 <= 5n, 'Rating <= 5 stars');
    const discRating_0 = rating_0;
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('feedback.compact line 13 char 20: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('feedback.compact line 14 char 15: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
                  })(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(tmp_1),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const isPositive_0 = discRating_0 >= 3n ? 1n : 0n;
    const tmp_2 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('feedback.compact line 17 char 19: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
                  })(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
